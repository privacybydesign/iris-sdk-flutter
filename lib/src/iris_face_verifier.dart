...
///
/// The SDK owns its camera UI end to end: [verify] hands it a reference
/// portrait and the SDK presents a full-screen native flow, returning only
/// the final outcome — there is no per-frame event stream to hook into.
class IrisFaceVerifier {
  static const MethodChannel _channel = MethodChannel('iris_sdk_flutter');
